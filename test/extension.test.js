...
test('ui exibem comando de atualizacao auditavel', () => {
  ...
  assert.strictEqual(popupJs.includes('updatePageUrl'), false);
  ...
  assert.strictEqual(optionsJs.includes('updatePageUrl'), false);
  ...
  assert.strictEqual(popupJs.includes("openLocalServiceAction('update')"), true);
  assert.strictEqual(optionsJs.includes("openLocalServiceAction('update')"), true);
